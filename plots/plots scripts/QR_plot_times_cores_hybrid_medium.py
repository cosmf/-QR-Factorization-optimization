...
# File name
filename = 'inputs/medium_plot.txt'
COLORMAP_NAME = 'cool'
...
plt.title("Execution Time as a function of Processors and Threads (Medium Dataset = 900)")
plt.tight_layout()
plt.savefig('../plots_png/QR_plot_times_cores_hybrid_medium.png')