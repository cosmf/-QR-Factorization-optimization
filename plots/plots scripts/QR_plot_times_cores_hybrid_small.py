...
# File name
filename = 'inputs/small_plot.txt'
COLORMAP_NAME = 'cool'
...
plt.title("Execution Time as a function of Processors and Threads (Small Dataset = 800)")
plt.tight_layout()
plt.savefig('../plots_png/QR_plot_times_cores_hybrid_small.png')